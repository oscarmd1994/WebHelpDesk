document.addEventListener('DOMContentLoaded', () => {
    ...
    const bodyCenters       = document.getElementById('body-localitys');
    ...
    fExtractionOfInformationOfLocalitys = () => {
            ...
            $.ajax({
                ...
                beforeSend: () => {
                    ...
                    if (data.Bandera == true && data.MensajeError == "none") {
                        ...
                        localStorage.setItem("countDbLocalitys", quantity);
    ...
    fImportDataLocalitysSip = (paramint, paramstr1) => {
        try {
            ...
            setTimeout(() => {
                ...
                const dataSend = { quantity: parseInt(localStorage.getItem("countDbLocalitys")), option: parseInt(paramint) };
                console.log(dataSend);
                $.ajax({
                    url: "../ImportBD/ImportLocalitysSIP",
                    type: "POST",
                    data: dataSend,
                    beforeSend: () => {
                        icoShowLoad.classList.add('text-primary');
    ...
    btnInsertData.addEventListener('click', () => {
        ...
        `;
        fImportDataLocalitysSip(1, 'Insertando información existente en el WS...');
    });
    ...
    btnUpdateData.addEventListener('click', () => {
        ...
        btnUpdateData.innerHTML = `
            <span class="spinner-grow spinner-grow-sm" role="status" aria-hidden="true"></span> Espere por favor...
        `;
        fImportDataLocalitysSip(2, 'Actualizando información existente en el WS...');
    });
