document.addEventListener('DOMContentLoaded', () => {
    ...
    const bodyPosts         = document.getElementById('body-posts'); 
    ...
    // Funcion que consulta los datos para llenar la tabla de puestos
    fExtractionOfInformationOfPosts = () => {
            ...
            $.ajax({
                ...
                beforeSend: () => {
                    ...
                    if (data.Bandera == true && data.MensajeError == "none") {
                        ...
                        localStorage.setItem("countDb", quantity);
    ...
    fImportDataPostsSip = (paramint, paramstr1) => {
        ...
        try {
            setTimeout(() => {
                ...
                $.ajax({
                    url: "../ImportBD/ImportPostSIP",
                    type: "POST",
                    data: { quantity: parseInt(localStorage.getItem("countDb")), option: parseInt(paramint) },
                    beforeSend: () => {
                        icoShowLoad.classList.add('text-primary');
                    }, success: (data) => {
                        console.log(data);
                        if (paramint == 1) {
                            ...
                            if (data.Actualizado === true || data.Busqueda == true) {
                               ...
                               setTimeout(() => {
                                    ...
                                    //dataBdDateSipdataBdDateSip.textContent = data.FechaSip;
    ...
    btnInsertData.addEventListener('click', () => {
        ...
        fImportDataPostsSip(1, 'Insertando información existente en el WS...');
    });
    ...
    btnUpdateData.addEventListener('click', () => {
        ...
        fImportDataPostsSip(2, 'Actualizando información existente en el WS...');
    });
